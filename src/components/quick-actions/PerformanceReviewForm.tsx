...
const PerformanceReviewForm = ({ reviewForm, onFormChange, onSubmit, onCancel }: PerformanceReviewFormProps) => {
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <select
              ...
              onChange={(e) => onFormChange(prev => ({ ...prev, employee: e.target.value }))}
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) => onFormChange(prev => ({ ...prev, reviewType: e.target.value }))}
              className="w-full p-2 border rounded-md"
            >
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) => onFormChange(prev => ({ ...prev, reviewer: e.target.value }))}
              className="w-full p-2 border rounded-md"
            >
          ...
          <div>
            ...
            <Input 
              ...
              onChange={(e) => onFormChange(prev => ({ ...prev, dueDate: e.target.value }))}
            />
          </div>
        </div>
        <div>
          ...
          <textarea
            ...
            onChange={(e) => onFormChange(prev => ({ ...prev, goals: e.target.value }))}
            placeholder="Enter review objectives and goals..."
