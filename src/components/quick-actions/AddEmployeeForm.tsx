...
const AddEmployeeForm = ({ employeeForm, onFormChange, onSubmit, onCancel }: AddEmployeeFormProps) => {
  ...
  const isDuplicateEmail = () => {
    ...
    return allEmployees.some(emp => 
      emp.email.toLowerCase() === employeeForm.email.toLowerCase()
    );
  };
      ...
      <CardContent className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            <Input 
              ...
              className={(!isValidEmail() || isDuplicateEmail()) ? 'border-red-300' : ''}
            />
          </div>
          <div>
        ...
        <div className="flex gap-2">
          <Button 
            ...
            disabled={!isFormValid() || !isValidEmail() || isDuplicateEmail()}
