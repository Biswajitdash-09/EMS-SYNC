...
const Dashboard = () => {
  ...
  const recentActivities = [
    { action: "New employee onboarded", employee: "Sarah Johnson", time: "2 hours ago", type: "success" },
    { action: "Leave request submitted", employee: "Mike Chen", time: "4 hours ago", type: "warning" },
    { action: "Payroll processed", employee: "All Employees", time: "1 day ago", type: "info" },
    { action: "Performance review completed", employee: "David Wilson", time: "2 days ago", type: "success" },
    { action: "Policy update published", employee: "HR Department", time: "3 days ago", type: "info" }
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h1 className="text-xl font-bold text-gray-900">EMS Pro Dashboard</h1>
